...
def compute_paths(symbol: str,
    ...
    default_models = "models/Transformer" if symbol == "BTCUSDT" else f"models/Transformer_{symbol}"
    default_logs   = "logs/Transformer"   if symbol == "BTCUSDT" else f"logs/Transformer_{symbol}"
